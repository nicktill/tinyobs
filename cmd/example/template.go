...
// statsPageTemplate is the HTML template for the stats dashboard page
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-value.uptime { font-size: 1.75rem; }
        .endpoints-list { display: grid; gap: 0.75rem; }
        .endpoint {
            display: flex;
            justify-content: space-between;
            align-items: center;
...
<body>
    ...
    <div class="header">
        <div class="header-content">
            <div class="logo"><span>●</span> TinyObs Example App</div>
    ...
    <script>
        ...
        setInterval(() => { addLog('📤 Metrics batch flushed to TinyObs'); }, 5000);
    </script>
</body>
</html>
`
